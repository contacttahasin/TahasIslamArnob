    ...
    <section className="relative w-full overflow-hidden px-6 pb-16 pt-32 sm:px-10 sm:pt-40 lg:px-16">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
        <div className="text-center lg:text-left">
          <span className="mb-4 inline-flex items-center gap-3 text-xs font-medium uppercase tracking-[0.4em] text-noir-gold">
            <span className="h-1 w-1 rounded-full bg-noir-gold" />
            <T ns="vlog" k="eyebrow" />
            <span className="h-1 w-1 rounded-full bg-noir-gold" />
          </span>

          <h1 className="font-jakarta-sans text-4xl font-bold uppercase tracking-tight text-noir-ink sm:text-6xl lg:text-7xl">
            Notes From{" "}
          ...
          <p className="mx-auto mt-6 max-w-md text-sm text-noir-ink-soft sm:text-base lg:mx-0">
