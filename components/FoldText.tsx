...
// Segments are separate inline-block spans, so the whitespace between them
// only needs to render visibly (a plain space collapses in HTML) — it does
// NOT need to be non-breaking. Using   here, like the upstream
// react-bits snippet does, disables line-wrapping at every word boundary,
// which is fine for a short one-line headline but breaks a multi-line body
// paragraph on narrow viewports (the whole sentence refuses to wrap).
