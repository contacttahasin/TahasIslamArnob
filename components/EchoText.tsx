      ...
      {copyIndexes
        ...
        .map(index => (
          <span
            ...
            style={{
              // Flat tint — every echo is the exact same color rather than a
              // per-index blend toward `color`, so the trail reads as one
              // accent hue (and follows the navbar theme when tint is
              // var(--accent)) instead of a gradient of mixed shades.
